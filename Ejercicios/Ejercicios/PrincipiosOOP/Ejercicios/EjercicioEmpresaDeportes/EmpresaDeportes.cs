...
namespace Ejercicios.PrincipiosOOP.Ejercicios.EjercicioEmpresaDeportes
{
    public class EmpresaDeportes
    {
        public void Ejercicio()
        {
            ...
            Console.WriteLine("Velociada: {0}", avioneta.DimeVelocidad());
            ...
            Console.WriteLine("Velociada: {0}", velero.DimeVelocidad());
            ...
            Console.WriteLine("Velociada: {0}", moto.DimeVelocidad());
            ...
            Console.WriteLine("Velociada: {0}",buggy.DimeVelocidad());
        }
